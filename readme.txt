...
Version 2.1.6 Adds ghost file protection for environments where PHP memory based failures cause the HTML generation process to fail rendering blank HTML files.
